...
loop:
    ...
    andi t4, t2, 1              # t4 = (n >> 4) & 1
    add t3, t3, t4              # count += (n >> 4) & 1
    srli t2, t2, 1              # n = n >> 5

    andi t4, t2, 1              # t4 = (n >> 5) & 1
    add t3, t3, t4              # count += (n >> 5) & 1
    srli t2, t2, 1              # n = n >> 6

    andi t4, t2, 1              # t4 = (n >> 6) & 1
    add t3, t3, t4              # count += (n >> 6) & 1
    srli t2, t2, 1              # n = n >> 7

    andi t4, t2, 1              # t4 = (n >> 7) & 1
    add t3, t3, t4              # count += (n >> 7) & 1
    srli t2, t2, 1              # n = n >> 8

    andi t4, t2, 1              # t4 = (n >> 8) & 1
    add t3, t3, t4              # count += (n >> 8) & 1
    srli t2, t2, 1              # n = n >> 9

    andi t4, t2, 1              # t4 = (n >> 9) & 1
    add t3, t3, t4              # count += (n >> 9) & 1
    srli t2, t2, 1              # n = n >> 10

    andi t4, t2, 1              # t4 = (n >> 10) & 1
    add t3, t3, t4              # count += (n >> 10) & 1
    srli t2, t2, 1              # n = n >> 11

    andi t4, t2, 1              # t4 = (n >> 11) & 1
    add t3, t3, t4              # count += (n >> 11) & 1
    srli t2, t2, 1              # n = n >> 12

    andi t4, t2, 1              # t4 = (n >> 12) & 1
    add t3, t3, t4              # count += (n >> 12) & 1
    srli t2, t2, 1              # n = n >> 13

    andi t4, t2, 1              # t4 = (n >> 13) & 1
    add t3, t3, t4              # count += (n >> 13) & 1
    srli t2, t2, 1              # n = n >> 14

    andi t4, t2, 1              # t4 = (n >> 14) & 1
    add t3, t3, t4              # count += (n >> 14) & 1
    srli t2, t2, 1              # n = n >> 15

    andi t4, t2, 1              # t4 = (n >> 15) & 1
    add t3, t3, t4              # count += (n >> 15) & 1
    srli t2, t2, 1              # n = n >> 16

    andi t4, t2, 1              # t4 = (n >> 16) & 1
    add t3, t3, t4              # count += (n >> 16) & 1
    srli t2, t2, 1              # n = n >> 17

    andi t4, t2, 1              # t4 = (n >> 17) & 1
    add t3, t3, t4              # count += (n >> 17) & 1
    srli t2, t2, 1              # n = n >> 18

    andi t4, t2, 1              # t4 = (n >> 18) & 1
    add t3, t3, t4              # count += (n >> 18) & 1
    srli t2, t2, 1              # n = n >> 19

    andi t4, t2, 1              # t4 = (n >> 20) & 1
    add t3, t3, t4              # count += (n >> 20) & 1
    srli t2, t2, 1              # n = n >> 21

    andi t4, t2, 1              # t4 = (n >> 21) & 1
    add t3, t3, t4              # count += (n >> 21) & 1
    srli t2, t2, 1              # n = n >> 22

    andi t4, t2, 1              # t4 = (n >> 22) & 1
    add t3, t3, t4              # count += (n >> 22) & 1
    srli t2, t2, 1              # n = n >> 23

    andi t4, t2, 1              # t4 = (n >> 23) & 1
    add t3, t3, t4              # count += (n >> 23) & 1
    srli t2, t2, 1              # n = n >> 24

    andi t4, t2, 1              # t4 = (n >> 24) & 1
    add t3, t3, t4              # count += (n >> 24) & 1
    srli t2, t2, 1              # n = n >> 25

    andi t4, t2, 1              # t4 = (n >> 25) & 1
    add t3, t3, t4              # count += (n >> 25) & 1
    srli t2, t2, 1              # n = n >> 26

    andi t4, t2, 1              # t4 = (n >> 26) & 1
    add t3, t3, t4              # count += (n >> 26) & 1
    srli t2, t2, 1              # n = n >> 27

    andi t4, t2, 1              # t4 = (n >> 27) & 1
    add t3, t3, t4              # count += (n >> 27) & 1
    srli t2, t2, 1              # n = n >> 28

    andi t4, t2, 1              # t4 = (n >> 28) & 1
    add t3, t3, t4              # count += (n >> 28) & 1
    srli t2, t2, 1              # n = n >> 29

    andi t4, t2, 1              # t4 = (n >> 29) & 1
    add t3, t3, t4              # count += (n >> 29) & 1
    srli t2, t2, 1              # n = n >> 30

    andi t4, t2, 1              # t4 = (n >> 30) & 1
    add t3, t3, t4              # count += (n >> 30) & 1
    srli t2, t2, 1              # n = n >> 31

    andi t4, t2, 1              # t4 = (n >> 31) & 1
    add t3, t3, t4              # count += (n >> 31) & 1
    srli t2, t2, 1              # n = n >> 32

    andi t4, t2, 1              # t4 = (n >> 32) & 1
    add t3, t3, t4              # count += (n >> 32) & 1
